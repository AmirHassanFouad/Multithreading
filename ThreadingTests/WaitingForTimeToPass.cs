...
//				canceled = token.WaitHandle.WaitOne(5000);
...
//			// avoiding a context switch but waisting resources
//			//Thread.SpinWait(10000); // pause the thread but you don't give up your place in execution task
//			//SpinWait.SpinUntil(() => canceled == true);
